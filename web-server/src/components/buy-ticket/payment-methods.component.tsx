...
const PaymentMethods = ({onChangeFunction, defaultCheck, methods}:typeOfPaymentMethodsParams)=>{
    ...
    return (
        ...
        <div>
            {
                methods.map((method)=>{
                    return (<div onClick={e=>check(method.id)} className={`${method.id === checked ? "checked-payment-method " : ""} payment-method`}>
