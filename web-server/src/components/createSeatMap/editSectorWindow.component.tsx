...
const EditSectorWindow = ({name, changeStairs, rowName, seatName, seatType, rowType, direction, setWatchingGroup, open, type, setDirectionOfSeats, id, rotated}:typeOfEditSectorParams)=>{
    ...
    <div>
        ...
        <Select options = {[{label : "Római szám", value : true}, {label : "Arab szám", value : false}]} defaultValue={rowType} />
        <h3>Szék neve</h3>
        <Input value = {seatName} />
        <h3>Szék számának típusa</h3>
        <Select options = {[{label : "Római szám", value : true}, {label : "Arab szám", value : false}]} defaultValue={seatType} />
